          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <form class="row g-6" method="POST" action="config/edit_a_fun.php" enctype="multipart/form-data"">
<?php
...
?>
                              <input type=" text" name="admin_id" class="form-control" placeholder="Enter name" value="<?php echo $row['aid']; ?>" disabled>
